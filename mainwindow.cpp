    ...
    ui(new Ui::MainWindow)
{
    ...
    Cubo* cc = new Cubo();
    cc->escalar(new Vertice(10,10,10));
    cc->transladar(new Vertice(10, 0, 0));
    for(int i = 0; i < cc->listaFace.size();i++){
        cc->listaFace[i]->mat->setMaterialOpenGL(11);
    }
